...
class Rule extends AppModel
{
	...
	/* Compute the fine based on date_return and now, counting only working days. 
	 * Rule 'fine_money' contains the amount of money (in cents) to pay per 
	 * fine. Rule 'fine_days' contains the amount of days to apply every fine.
	 *
	 */
